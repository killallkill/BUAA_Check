...
public class MyCheckCheckDetailAdapter extends RecyclerView.Adapter<MyCheckCheckDetailAdapter.ViewHolder> {

    private List<CheckCheckDetail> mData;

    public MyCheckCheckDetailAdapter(List<CheckCheckDetail> data) {
        mData = data;
    }

    public void setData(List<CheckCheckDetail> data) {
        mData = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.checkcheck_detail_item, parent, false);
